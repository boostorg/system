...
def main(ctx):
  ...
  linux_cxx("GCC 9* 20.04 UBSAN", "", packages="g++-multilib", buildscript="drone", image="cppalliance/droneubuntu2004:1", environment={'UBSAN': 1, 'TOOLSET': 'gcc', 'COMPILER': 'g++', 'CXXSTD': '03,11,14,17,2a', 'ADDRMD': '32,64', 'LINKFLAGS': '-fuse-ld=gold'}, globalenv=globalenv),
