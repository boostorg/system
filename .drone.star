...
def main(ctx):
  ...
  linux_cxx("GCC 4.4", "", packages="g++-4.4", buildscript="drone", image=linuxglobalimage, environment={'TOOLSET': 'gcc', 'COMPILER': 'g++-4.4', 'CXXSTD': '98,0x'}, globalenv=globalenv),
  linux_cxx("GCC 4.6", "", packages="g++-4.6", buildscript="drone", image=linuxglobalimage, environment={'TOOLSET': 'gcc', 'COMPILER': 'g++-4.6', 'CXXSTD': '03,0x'}, globalenv=globalenv),
  linux_cxx("GCC 6", "", packages="g++-6", buildscript="drone", image=linuxglobalimage, environment={'TOOLSET': 'gcc', 'COMPILER': 'g++-6', 'CXXSTD': '03,11,14,1z'}, globalenv=globalenv),
  linux_cxx("GCC 10 UBSAN", "", packages="g++-10", buildscript="drone", image="cppalliance/droneubuntu1804:1", environment={'UBSAN': '1', 'TOOLSET': 'gcc', 'COMPILER': 'g++-10', 'CXXSTD': '03,11,14,17,20', 'LINKFLAGS': '-fuse-ld=gold'}, globalenv=globalenv),
  linux_cxx("GCC 11 UBSAN", "", packages="g++-11", buildscript="drone", image="cppalliance/droneubuntu1804:1", environment={'UBSAN': '1', 'TOOLSET': 'gcc', 'COMPILER': 'g++-11', 'CXXSTD': '03,11,14,17,20', 'LINKFLAGS': '-fuse-ld=gold'}, globalenv=globalenv),
  ...
  linux_cxx("Clang 11 UBSAN", "", packages="clang-11", llvm_os="xenial", llvm_ver="11", buildscript="drone", image=linuxglobalimage, environment={'UBSAN': '1', 'TOOLSET': 'clang', 'COMPILER': 'clang++-11', 'CXXSTD': '03,11,14,17,20'}, globalenv=globalenv),
  linux_cxx("Clang 12 UBSAN", "", packages="clang-12", llvm_os="xenial", llvm_ver="12", buildscript="drone", image=linuxglobalimage, environment={'UBSAN': '1', 'TOOLSET': 'clang', 'COMPILER': 'clang++-12', 'CXXSTD': '03,11,14,17,20,2b'}, globalenv=globalenv),
  linux_cxx("Clang 13 UBSAN", "", packages="clang-13", llvm_os="bionic", llvm_ver="13", buildscript="drone", image="cppalliance/droneubuntu1804:1", environment={'UBSAN': '1', 'TOOLSET': 'clang', 'COMPILER': 'clang++-13', 'CXXSTD': '03,11,14,17,20,2b'}, globalenv=globalenv),
  linux_cxx("Clang 14 UBSAN", "", packages="clang-14", llvm_os="bionic", llvm_ver="14", buildscript="drone", image="cppalliance/droneubuntu1804:1", environment={'UBSAN': '1', 'TOOLSET': 'clang', 'COMPILER': 'clang++-14', 'CXXSTD': '03,11,14,17,20,2b'}, globalenv=globalenv),
